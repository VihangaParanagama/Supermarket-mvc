...
public class OrderController {
   ...
   public String placeOrder(OrderModel orderModel, ArrayList<OrderDetails> orderDetailModels) throws SQLException {
        ...
        try {
            ...
            if (statementForOrder.executeUpdate() > 0) {
                ...
                for (OrderDetails orderDetailModel : orderDetailModels) {
